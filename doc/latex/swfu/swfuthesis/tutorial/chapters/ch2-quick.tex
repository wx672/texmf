...
\item \Cx\Cf{}，开始编辑一个新文件。这时，在Emacs窗口的最下面（也就是mini buffer里）有提
...
如果你对Emacs操作还很陌生，那么现在就打开Emacs，\Ch{}{\lbkey t}，重温一下那些基本操作吧。
...
\item 左手无名指稍向下移，在{\lbkey x}键上轻按一下就放开，这就是\Cx{}；
\item 小指按在\Caps{}上别放开，左手食指在{\lbkey f}键上轻按一下就放开，这就是\Cf{}；
\item 现在左手小指可以放开了。
\end{enumerate}
...
\begin{itemize}
\item 什么是 \Cx \Cs?
\item 什么是 \Cx {\lbkey 2}? 什么是\Cx {\lbkey 3}? 什么是\Cx {\lbkey o}? 什么是\Cx {\lbkey 0}? 什么
  是\Cx {\lbkey 1}?
\item 什么是\Cx {\lbkey h}? 什么是\Cw{}?
\item 什么是 \Cg{}?
\item 什么是\Cj{}? 什么是 \Ci{}?
  % \item 什么是 \LKeyCtrlX{/}?
\item 什么是 \Ck{}? 什么是 \Cy{}?
...
们改造成\Ctrl{}了）。右手食指下不正是{\lbkey j}键吗？怎么样，比\Enter{}更方便吧。
...
输入之后，\MEnter{}，也就是，左手拇指按住{\lbkey }键，同时右手小指去敲\Enter{}。你会看到
这样的效果：
\begin{codeblock}[.9]
\begin{latexcode}
  \begin{itemize}
...
\paragraph{最基本的Emacs快捷键（大多以\Cx{}开头）}
\label{p:keys}
...
\begin{center}
  \begin{tabular}{rl|rl}
    横分：&\Cx{}{\lbkey 2}&纵分：&\Cx{}{\lbkey 3}\\
    \hspace{1em}保留我：&\Cx{}{\lbkey 1}&关掉我：&\Cx{}{\lbkey 0}\\
    切换：&\Cx{}{\lbkey o}&&\\
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{rl|rl}
    教程：&\Ch{}{\lbkey t}&info：&\Ch{}{\lbkey i}\\
    \hspace{1em}快捷键：&\Ch{}{\lbkey k}&\hspace{1em}函数：&\Ch{}{\lbkey f}\\
    变量：&\Ch{}{\lbkey v}&&\\
  \end{tabular}
\end{center}

\paragraph{最基本的\auctex{}快捷键（大多以\Cc{}开头）}
