...
\swfusetup{
  ...
  Author       ={王晓林}, % 作者姓名
  enTitle      ={How to write your dissertation with \LaTeX}, % 论文标题（英文）
...
\begin{EAbstract} % 英文摘要
  ...
  can also serve as a perfect template to ease your life\footnote{The class file used
...
\begin{EKeyword} % 英文关键词
  \LaTeX{}, \TeX{}, dissertation template, SWFU
\end{EKeyword}
