...
\swfusetup{
  Title={一种高效回收僵尸进程资源的方法},%论文题目
  enTitle={AN EFFICIENT METHOD FOR RELEASING RESOURCES FROM A ZOMBIE PROCESS},%题目英文
  Author={罗志兵},%作者姓名
  enAuthor={LUO Zhibing},%作者姓名英文
  AuthorId={20151111002},%学号
  Advisor={赵家刚},%指导教师
  enAdvisor={ZHAO Jiagang (Associate Professor)},%指导教师英文
  AdvisorTitle={副教授},%指导教师职称
  ClsID={TP316.85},%分类号
  Month, Year,%月、年
  ...
  DateC,%独创性声明页上的日期
  Subject={林业信息工程},%学科专业
  enSubject={Forestry information engineering},%学科专业英文
  Chairman=杨毅,%答辩委员会主席
}
