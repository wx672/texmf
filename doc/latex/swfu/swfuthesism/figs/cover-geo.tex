...
\begin{tikzpicture}[inner sep=0,anchor=south west,
  markline/.style={<->,red,dashed,thin},%
  tick/.style={red,dashed,thin},%
  ]
  ...
  \begin{scope}
    ...
    \node[red, inner sep=1pt,align=center,anchor=south] at (11,28.35) {页眉（宋体小5号字，居中）};
